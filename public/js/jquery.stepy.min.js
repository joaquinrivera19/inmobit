    ...
    var a = {
        init: function (c) {
            return this.each(function () {
                ...
                if (g.titleClick) {
                    d.click(function () {
                        var s = d.filter(".current-step").attr("id").split("-"), r = parseInt(s[s.length - 1], 10),
                            q = b(this).index();
                        if (q > r) {
            ...
            b("<a/>", {
                ...
                "class": "btn btn-primary align_left",
                html: d.backLabel
            }).click(function () {
            ...
            b("<a/>", {
                id: f + "-next-" + c,
                href: "javascript:void(0);",
                "class": "btn btn-primary align_right",
                html: d.nextLabel
            }).click(function () {
            ...
            var c = this.children("fieldset").eq(d), h = true,
                f = b("#" + this.attr("id") + "-titles").children().eq(d), e = this.data("options"),
                g = this.validate();
