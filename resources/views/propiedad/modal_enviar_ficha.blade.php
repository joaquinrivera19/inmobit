<!-- Modal Enviar Ficha -->
<div class="modal modal-responsive modal-mail fade" id="modal_enviar_ficha" role="dialog">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header modal-header--orange">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span>
                </button>
                <h4 class="modal-title" id="modal-login-label">Enviar Ficha</h4>
            </div>
            ...
            <div class="modal-body">
                ...
                <div class="mail-table">
                    <table class="data-contact-mail" tabindex="-1">
                        ...
                        <tr>
                            <td width="60px">
                                <label class="label-mail">Web: </label>
                            </td>
                            <td colspan="2" class="pub_id">
                                <input name="cuerpo_email" class="form-control-mail">
                            </td>
                        </tr>
