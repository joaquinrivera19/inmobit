...
<div class="modal modal-tasacion fade modal-responsive" id="modal_propietario_create" role="dialog">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header modal-header--orange">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span
                            aria-hidden="true">&times;</span></button>
                <h4 class="modal-title" id="modal-login-label">Nuevo Propietario</h4>
            </div>

            {!! Form::open(array('route' => ['propietario.store', 'method' => 'POST'],'id' => 'form_propietario_create')) !!}
            ...
            {!! Form::text('url', URL::to('/'),["style" =>"display: none"]) !!}
                ...
                <div class="modal-footer">
                    <button type="submit" class="btn btn-blue pull-right">Crear Propietario</button>
                </div>
            {!! Form::close() !!}
        </div>
    </div>
