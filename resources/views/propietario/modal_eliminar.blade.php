...
<div class="modal modal-tasacion fade modal-responsive" id="modal_propietario_eliminar" role="dialog">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header modal-header--orange">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span
                            aria-hidden="true">&times;</span></button>
                <h4 class="modal-title" id="modal-login-label">Seguro desea eliminar el siguiente Propietario?</h4>
            </div>

            {!! Form::model($propietario,['method' => 'PATCH','route'=>['propietario.update','id'=>'idpropiestario']]) !!}
            ...
            <div class="modal-footer">
                <button type="submit" class="btn btn-blue pull-right">Eliminar Propietario</button>
