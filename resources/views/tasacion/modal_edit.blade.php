...
<div class="modal modal-tasacion fade modal-responsive" id="modal_tasacion_edit" role="dialog">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header modal-header--orange">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span
                            aria-hidden="true">&times;</span></button>
                <h4 class="modal-title" id="modal-login-label">Editar Tasación</h4>
            </div>

            {!! Form::model($tasacion,['method' => 'PATCH','route'=>['tasacion.update','id'=>'idtasacion'],'id' => 'form_tasacion_edit']) !!}
                ...
                <div class="row">
                    <div class="col-md-4">
                        ...
                        <div class="form-group per_apellido">
                            {!! Form::text('per_apellido', null , ['class' => 'form-control apellido']) !!}
                    ...
                    <div class="col-md-4">
                        ...
                        <div class="form-group per_nombre">
                            {!! Form::text('per_nombre', null , ['class' => 'form-control nombre']) !!}
                            <p class="help-inline"></p>
                        </div>
                    </div>
                    <div class="col-md-4">
                        ...
                        <div class="form-group per_dni">
                            {!! Form::text('per_dni', null , ['class' => 'form-control dni']) !!}
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-md-4">
                        ...
                        <div class="form-group per_email">
                            {!! Form::text('per_email', null , ['class' => 'form-control email']) !!}
                        </div>
                    </div>
                    <div class="col-md-4">
                        {!! Form::label('per_tel_fijo', 'Teléfono Fijo') !!}
                        <div class="form-group per_tel_fijo">
                            {!! Form::text('per_tel_fijo', null , ['class' => 'form-control tel_fijo']) !!}
                            <p class="help-inline"></p>
                        </div>
                    </div>
                    <div class="col-md-4">
                        ...
                        <div class="form-group per_tel_cel">
                            {!! Form::text('per_tel_cel', null , ['class' => 'form-control tel_cel']) !!}
                            <p class="help-inline"></p>
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <div class="form-group per_domicilio">
                            {!! Form::text('per_domicilio', null , ['class' => 'form-control domicilio']) !!}
                            <p class="help-inline"></p>
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                            ...
                            <div class="form-group">
                                <div class="row row-xs">
                                    <div class="col-xs-4 col-lg-3">
                                        {!! Form::select('mon_id',$moneda, null, ['class' => 'form-control mon_id']) !!}
                                    </div>
                                    <div class="col-xs-8 col-lg-9 tas_valor_venta">
                                        {!! Form::text('tas_valor_venta', null , ['class' => 'form-control']) !!}
                                    </div>
                                </div>
                            </div>
                            <div class="form-group">
                                <div class="row row-xs">
                                    <div class="col-xs-4 col-lg-3">
                                        {!! Form::select('mon_id2',$moneda, null, ['class' => 'form-control mon_id']) !!}
                                    </div>
                                    <div class="col-xs-8 col-lg-9 tas_valor_alq">
                                        {!! Form::text('tas_valor_alq', null , ['class' => 'form-control']) !!}
                                    </div>
                                </div>
                            </div>
                            <div class="form-group">
                                <div class="row row-xs">
                                    <div class="col-xs-4 col-lg-3">
                                        {!! Form::select('mon_id3',$moneda, null, ['class' => 'form-control mon_id']) !!}
                                    </div>
                                    <div class="col-xs-8 col-lg-9 tas_valor_alq_temp">
                                        {!! Form::text('tas_valor_alq_temp', null , ['class' => 'form-control']) !!}
                                    </div>
                                </div>
                            </div>
                        </section>
                    ...
                    <div class="col-xs-12 col-sm-6 col-md-6">
                        <section class="form-block">
                            ...
                            <div class="form-group">
                                {!! Form::text('per_domicilio', null , ['class' => 'form-control']) !!}
                            </div>
                        </section>
                    </div>
                </div>
                <div class="row">
                    <div class="col-xs-12 col-sm-6 col-md-6">
                        <section class="form-block">
                            ...
                            <div class="form-group">
                                {!! Form::select('tipoinmu_id',$tipoinmueble, null, ['class' => 'form-control','id' => 'tipoinmu_id']) !!}
                            </div>
                        </section>
                        <section class="form-block">
                            {!! Form::label('tas_valor_tasacion', 'Comisión / Costo Tasación') !!}
                            <div class="form-group valor_tasacion">
                                {!! Form::text('tas_valor_tasacion', null , ['class' => 'form-control']) !!}
                            </div>
                        </section>
                    </div>
                    <div class="col-xs-12 col-sm-6 col-md-6">
                                ...
                                <div class="col-xs-12 col-sm-6 col-md-6">
                                    <div class="form-group">
                                        <div class="input-group">
                                            ...
                                            {!! Form::select('numamb_id',$numeroambiente, null, ['class' => 'form-control','style' => 'width: 87px;','id' => 'numamb_id']) !!}
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <div class="input-group">
                                            <span class="input-group-addon">Baños</span>
                                            {!! Form::select('ban_id',$numerobanio, null, ['class' => 'form-control','style' => 'width: 87px;','id' => 'ban_id']) !!}
                                        </div>
                                    </div>
                                    <div class="form-group">
                                ...
                                <div class="col-xs-12 col-sm-6 col-md-6">
                                    <div class="form-group">
                                        <div class="input-group">
                                            ...
                                            {!! Form::select('hab_id',$numerohabitacion, null, ['class' => 'form-control','style' => 'width: 87px;', 'id' => 'hab_id']) !!}
                                        </div>
                                    </div>
                                    <div class="form-group">
            ...
            <div class="modal-footer">
                <button type="submit" class="btn btn-blue pull-right">Editar Tasación</button>
